    ...
    <main className="min-h-screen">
      ...
      <section className="relative bg-slate-900 text-white py-20 md:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://txeynebsnznkoqkhmuag.supabase.co/storage/v1/object/public/Gurovich/images/contact-hero-bg.jpg"
            alt="Modern law office interior with professional meeting space"
